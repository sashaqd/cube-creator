...
curl -D- -H 'Content-Type: text/turtle' --upload-file meta files/meta.nt -X POST 'http://10.230.240.198:9999/bigdata/namespace/wdq/sparql?context-uri=urn:graph:meta'
curl -D- -H 'Content-Type: text/turtle' --upload-file meta files/organization.nt -X POST 'http://10.230.240.198:9999/bigdata/namespace/wdq/sparql?context-uri=urn:graph:meta'
